                    ...
                    <div className={`${styles.insta__contianer} ${styles.container}`}>
                        <div className={styles.insta__body}>
                            ...
                            <div className={styles.insta__mobileImages}>
                                <div className={`${styles.insta__mobileImages_container} ${styles.container}`}>
                                    <div className={`${styles.insta__mobileImages_skateShmot} ${styles.img}`}>
                                        <img src="./images/skateShmot.png" alt="Skate Shmot"/>
                                    </div>
                                    <div className={`${styles.insta__mobileImages_instaHand} ${styles.img}`}>
                                        <img src="./images/instaHand.png" alt="Instagram"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={styles.insta__link}>
                                <a href="https://www.instagram.com/galierydrop?igshid=MzRlODBiNWFlZA%3D%3D">
                                    <div
                                        className={`${styles.insta__linkIcon} ${styles.img}`}
                                    >
                                        <svg
                                            width="24"
                                            height="24"
                                ...
                                <div className={styles.insta__link_hr}></div>
                            </div>
                        </div>
                        <div className={styles.insta__handImg}>
                            <img src="./images/instaHand.png" alt="Instagram"/>
                        </div>
                    </div>
                </div>
                <div className={styles.insta__image}>
                    <img src="./images/skateShmot.jpg" alt="Skate Shmot"/>
                </div>
            </section>
        </div>
    );
