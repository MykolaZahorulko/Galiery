                ...
                <div className={styles.header__body}>
                    ...
                    >
                        <ul className={styles.menu__list}>
                            ...
                            <li className={styles.menu__item}><Link
                                to="/login" onClick={() => dispatch(toggleBurgerMenu(false))}>
