                ...
                <div className={styles.footer__body}>
                    ...
                    <div className={styles.footer__item}>
                        ...
                        <div className={styles.footer__item_input}>
                            <input type="text" placeholder="Ваша пошта" value={inputValue}
                                   onChange={(event) => setInputValue(event.target.value)}/>
                            {!isSubscribe ? <div className={`${styles.footer__item_inputStringIcon} ${styles.img}`}
                            ...
                            </div> : <div className={`${styles.footer__item_inputCheckIcon} ${styles.img}`}
                        ...
                        <p className={`${isSubscribe ? styles._active : ''}`}>Дякуємо, що підписалися на нашу розсилку!
                            Тепер Ви завжди знатимете інформацію про всі наші новини.</p>
                    </div>
                </div>
            </div>
        </footer>
